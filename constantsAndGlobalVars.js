...
let language;
let oldLanguage = 'en';
let currentPrizeClassification = [];
...
const MIN_COUNTDOWN_TIME_BONUS_GRAPHIC = 45; //45
const MAX_COUNTDOWN_TIME_BONUS_GRAPHIC = 200; //200
...
const CAP_POTATO_CAPACITY = 1000;
...
let priceToEnableDoubleChipping = 30;
let priceToEnableDoublePeeling = 36;
let priceToImproveFryerCapacity = 40;
let priceToAddStorageHeater = 50;
let priceToImproveAutoPeeler = 30;
let priceToImproveAutoChipper = 30;
let priceToImproveAutoFryer = 60;
let priceToImproveAutoStorageCollector = 40;
let priceToImproveAutoCustomerServer = 80;
let priceToImproveFryTimer = 100;
let priceToDoubleSpudsMax = 80;
let priceToIncreaseFootfall = 180;
...
export function setElements() {
    elements = {
        ...
        investmentDataScreenTopRowColumn5: document.getElementById('investmentDataScreenTopRowColumn5'),
        ...
        investmentDataScreenBottomRowColumn5: document.getElementById('investmentDataScreenBottomRowColumn5'),
...
export function setCurrentPrizeClassifications(value) {
    currentPrizeClassification = value;
}

export function getCurrentPrizeClassifications() {
    return currentPrizeClassification;
}
